...
void GameMenu::handleKeyPressed()
{
    switch (event.key.code) {
        case (sf::Keyboard::Z):
            isDirectionMaintained[gameEntities.get()->DIRECTION::UP] = true;
            break;
        case (sf::Keyboard::Q):
            isDirectionMaintained[gameEntities.get()->DIRECTION::LEFT] = true;
            break;
        case (sf::Keyboard::S):
            isDirectionMaintained[gameEntities.get()->DIRECTION::DOWN] = true;
            break;
        case (sf::Keyboard::D):
            isDirectionMaintained[gameEntities.get()->DIRECTION::RIGHT] = true;
            break;
        default:
            break;
    }
...
{
    if (gameEntities.get()->isGamePlaying()) {
        switch (event.key.code) {
            case (sf::Keyboard::Z):
                isDirectionMaintained[gameEntities.get()->DIRECTION::UP] = false;
                break;
            case (sf::Keyboard::Q):
                isDirectionMaintained[gameEntities.get()->DIRECTION::LEFT] = false;
                break;
            case (sf::Keyboard::S):
                isDirectionMaintained[gameEntities.get()->DIRECTION::DOWN] = false;
                break;
            case (sf::Keyboard::D):
                isDirectionMaintained[gameEntities.get()->DIRECTION::RIGHT] = false;
                break;
            default:
                break;
        }
